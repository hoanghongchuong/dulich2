      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            <li><a href="backend/productcate"><i class="fa fa-circle-o"></i> <span>Danh mục tour</span></a></li>
            <li><a href="backend/product"><i class="fa fa-circle-o"></i> <span>Danh sách tour</span></a></li>
        ...
        <!-- <li><a href="backend/orders"><i class="fa fa-circle-o"></i> <span>Quản lý đặt hàng</span></a></li> -->
        <!-- <li class="treeview">
          <a href="#">
        ...
        <li><a href="backend/news?type=bai-viet"><i class="fa fa-circle-o"></i> <span>Bài viết giới thiệu</span></a></li>
       ...
       <!--  <li>
        ...
        <!-- <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Quản lý thư viện ảnh</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="backend/categallery"><i class="fa fa-circle-o"></i> <span>Danh mục</span></a></li>
            <li><a href="backend/gallery"><i class="fa fa-circle-o"></i> <span>Ảnh</span></a></li>
          </ul>
        </li> -->
