...
<!-- 							<div class="form-group">
								<div class="form-group">
									<img src="{{ asset('upload/hinhanh/'.$data->image) }}" onerror="this.src='{{asset('public/admin_assets/images/no-image.jpg')}}'" width="200"  alt="NO PHOTO" />
								</div>
								<label for="file">Chọn file logo footer</label>
							 	<input type="file" id="file" name="fImagesFooter" >
								<p class="help-block">Width:234px - Height: 51px</p>
							</div> -->
	                	</div>
