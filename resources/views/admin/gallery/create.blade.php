...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="{!! route('admin.gallery.postAdd') !!}" enctype="multipart/form-data">
        		<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
          		<div class="col-md-6 col-xs-12">
			    	...
			    	<div class="form-group @if ($errors->first('txtName')!='') has-error @endif">
				      	...
				      	<select name="cateGallery" class="form-control">
				      		<?php $cates = DB::table('cate_gallery')->get(); ?>
			    ...
			    <div class="box-footer">
			    	<div class="row">
						<div class="col-md-6">
					    	...
					    	<button type="button" onclick="javascript:window.location='backend/gallery'" class="btn btn-danger">Thoát</button>
				    	</div>
			    	</div>
			  	</div>
		    </form>
