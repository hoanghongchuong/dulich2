...
class ContactController extends Controller {
    ...
    public function postContact(Request $request)
	{
		...
		// $data->ngaydi = $request->ngaydi;
		// $data->numb_adults = $request->numb_adults;
		// $data->numb_child = $request->numb_child;
		// $data->numb_room = $request->numb_room;
		...
		echo "<script type='text/javascript'>
			alert('Cảm ơn bạn đã đặt phòng. Chúng tôi sẽ liên hệ lại với bạn sớm nhất !');
