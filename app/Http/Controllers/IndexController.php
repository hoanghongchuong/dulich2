...
class IndexController extends Controller {
	...
	*/
	...
	public function index()
	{
		...
		$tintuc_moinhat = DB::table('news')->select()->where('status',1)->where('com','tin-tuc')->orderBy('created_at','desc')->take(8)->get();
		$com='index';
		$hot_news = DB::table('news')->where('status',1)->where('noibat',1)->orderBy('created_at','desc')->get();
		// dd($hot_news);
		...
		$cateHots = DB::table('product_categories')->get();
	...
	public function getProduct()
	{
		...
		$products = DB::table('products')->select()->where('status',1)->orderby('stt','desc')->paginate(20);
	...
	public function getAbout()
	{
		...
		$tintuc = DB::table('news')->select()->where('status',1)->where('com','bai-viet')->orderby('id','desc')->get();
		$news_detail = DB::table('news')->select()->where('status',1)->where('com','bai-viet')->first();
		$com='gioi-thieu';
		...
		return view('templates.about_tpl', compact('about','slider_about','banner_danhmuc','keyword','description','title','img_share','com','tintuc','news_detail'));
	}
	...
	public function getNews()
	{
		...
		// dd($cateNews);
		$tintuc = DB::table('news')->select()->where('status',1)->where('com','tin-tuc')->orderby('id','desc')->paginate(20);
		$banner_danhmuc = DB::table('lienket')->select()->where('status',1)->where('com','chuyen-muc')->where('link','tin-tuc')->get()->first();
		$tintuc_noibat = DB::table('news')->select()->where('status',1)->where('noibat','>',0)->where('com','tin-tuc')->orderBy('id','desc')->take(2)->get();
		// $camnhan_khachhang = DB::table('lienket')->select()->where('status',1)->where('com','cam-nhan')->orderby('stt','asc')->get();
		$com='tin-tuc';
		// Cấu hình SEO
		$title = "Tin tức";
	...
	public function getNewsDetail($id)
	{
		...
		if(!empty($news_detail)){
			...
			$tintuc_moinhat_detail = DB::table('news')->select()->where('status',1)->where('com','tin-tuc')->orderby('created_at','desc')->take(6)->get();
			$tinkhac = DB::table('news')->where('status',1)->where('id','<>',$id)->take(6)->get();
			$hot_news = DB::table('news')->where('status',1)->where('noibat',1)->orderBy('created_at','desc')->take(5)->get();
    ...
    public function gallary(){
    	$cateGallery = DB::table('cate_gallery')->get();
    	return view('templates.gallery_tpl', compact('cateGallery'));
    }
    public function gallaryDetail($alias){
    	$cate = DB::table('cate_gallery')->where('alias', $alias)->first();
    	$gallerys = DB::table('gallery')->where('cate_id', $cate->id)->get();
    	return view('templates.gallerydetail_tpl',compact('cate','gallerys'));
    }
